...
import { useState } from 'react'
import { getDashboard } from '../api.js'
import { GridIcon, InboxIcon } from '../icons.jsx'
...
function Dashboard({ repoName }) {
    ...
    return (
      <div className="card">
        <div className="empty-panel">
          ...
          <p>Upload a repository first, then come back here to see the analysis.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div>
      <button onClick={loadDashboard} disabled={loading}>
        <GridIcon width="14" height="14" style={{ marginRight: 6, verticalAlign: -2 }} />
        {loading ? 'Loading…' : 'Load Dashboard'}
      </button>
